...
<div class="space-y-6">
    ...
    <div class="md:flex md:items-center md:justify-between">
        ...
        <div class="mt-4 flex md:mt-0 md:ml-4">
            <a href="<?php echo e(route('posts.show', $post)); ?>" class="mr-3 inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
    ...
    <!-- Form -->
    <form method="POST" action="<?php echo e(route('posts.update', $post)); ?>" enctype="multipart/form-data" class="space-y-6">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <?php if($post->getFirstMediaUrl('featured_image')): ?>
                    <div>
                        ...
                        <div class="flex items-center space-x-4">
                            <img src="<?php echo e($post->getFirstMediaUrl('featured_image', 'thumb')); ?>" alt="Featured image" class="h-20 w-20 object-cover rounded-lg">
                            <div>
                                <p class="text-sm text-gray-500">Current featured image</p>
                                <p class="text-xs text-gray-400">Upload a new image below to replace it</p>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <div>
                    <label for="featured_image" class="block text-sm font-medium text-gray-700">
                        <?php echo e($post->getFirstMediaUrl('featured_image') ? 'Replace Featured Image' : 'Featured Image'); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="px-4 py-3 bg-gray-50 text-right sm:px-6 space-x-2">
                <a href="<?php echo e(route('posts.show', $post)); ?>" class="inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    Cancel
                </a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/afifacheema/Downloads/multi-tenant-cms/resources/views/posts/edit.blade.php ENDPATH**/ ?>